...
const Login2 = () => {
    ...
    <div class="flex max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
        ...
        <div class="w-full px-6 py-8 md:px-8 lg:w-1/2">
            ...
            <a href="#f" class="flex items-center justify-center mt-4 text-gray-600 border rounded-lg dark:bg-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                <div class="px-4 py-2">
            ...
            <div class="flex items-center justify-between mt-4">
                ...
                <a href="#f" class="text-xs text-center text-gray-500 uppercase dark:text-gray-400 hover:underline">or login with email</a>
            ...
            <div class="mt-4">
                <div class="flex justify-between">
                    ...
                    <a href="#df" class="text-xs text-gray-500 dark:text-gray-300 hover:underline">Forget Password?</a>
                </div>
            ...
            <div class="flex items-center justify-between mt-4">
                ...
                <a href="#f" class="text-xs text-gray-500 uppercase dark:text-gray-400 hover:underline">or sign up</a>
