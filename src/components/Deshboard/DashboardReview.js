...
import '../Deshboard/Admin/AddService/AddService.css'
const DashboardReview = () => {
  const [success,setSuccess]=useState(false)
    ...
    const onSubmit = data => {
        console.log(data)
        axios.post('https://thawing-headland-16581.herokuapp.com/review',data)
.then(res=>{
    ...
    <h1 className="text-2xl font-bold mb-8 text-center">Add a Review for our Services</h1>
    {
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="relative z-0 w-full mb-5">
        ...
        />
        <label for="text" className="absolute duration-300 top-3 -z-1 origin-0 text-gray-500">Your Name</label>
      ...
      <div className="relative z-0 w-full mb-5">
        ...
        {...register("profession")}
          ...
          className="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200"
        />
        <label for="text" className="absolute duration-300 top-3 -z-1 origin-0 text-gray-500">Your Profession</label>
        <span className="text-sm text-red-600 hidden" id="error">Title is required</span>
      </div>
      <div className="relative z-0 w-full mb-5">
        <input
        {...register("title")}
          ...
          className="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200"
        />
        <label for="text" className="absolute duration-300 top-3 -z-1 origin-0 text-gray-500">Review Out of 5</label>
        <span className="text-sm text-red-600 hidden" id="error">Title is required</span>
      </div>
