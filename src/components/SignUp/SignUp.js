...
<div className="min-w-screen min-h-screen flex flex-col items-center justify-center px-5 py-5">
    ...
    <div className=" rounded-3xl shadow w-full overflow-hidden" >
                    ...
                    <div className="flex -mx-3">
                        <div className="w-full px-1 mb-5">
                            ...
                            <div className="flex">
                                ...
                                <input onBlur={handelUserName} type="text" className="w-full -ml-10 pl-3 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-red-500" placeholder="John"/>
                            </div>
                        </div>
                    ...
                    <div className="flex -mx-3">
                        <div className="w-full px-1 mb-5">
                            ...
                            <div className="flex">
                                ...
                                <input onBlur={handleUserEmail} type="email" className="w-full -ml-10 pl-3 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-red-500" placeholder="youreail@example.com"/>
                            </div>
                        </div>
                    </div>
                    <div className="flex -mx-3">
                        <div className="w-full px-1 mb-12">
                            ...
                            <div className="flex">
                                ...
                                <input onBlur={handelUserPassword} type="password" className="w-full -ml-10 pl-3 pr-1 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-red-500" placeholder="************"/>
                            </div>
                        </div>
                    </div>
                    <div className="flex -mx-3">
                        <div className="w-full px-3 mb-5">
                            ...
                            className="block w-full max-w-xs mx-auto bg-red-500 hover:bg-red-700 focus:bg-red-700 text-white rounded-lg px-3 py-3 font-semibold">REGISTER NOW</button>
                        </div>
                    </div>
